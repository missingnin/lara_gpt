...
use App\Http\Controllers\OtDushiApiController;
...
Route::prefix('ot_dushi')->group(function () {
    Route::post('/get_spreads', [OtDushiApiController::class, 'getAiSpreads'])->name('od.getSpreads');
});
